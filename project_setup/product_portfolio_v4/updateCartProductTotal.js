...
export const updateCartProductTotal = async () => {
  if (isLoggedIn()) {
    try {
      ...
      const productDetailsResponse = await fetch('http://147.93.106.209:3000/get-product-cart-details', {
        method: 'POST',
        headers: {
      ...
      const appliedCouponsResponse = await fetch('http://147.93.106.209:3000/get-applied-coupons', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
      ...
      const couponDetailsResponse = await fetch('http://147.93.106.209:3000/get-coupons-applied', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
