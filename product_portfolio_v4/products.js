        ...
        document.addEventListener('DOMContentLoaded', function() {
           if(queryParamsLength == 1)
           {
            ...
            async function fetchCategories() {
                try {
                    const response = await fetch('https://happywaycreations.52.66.203.206.nip.io:3000/categories'); // Replace with your API endpoint
                    if (!response.ok) {
            ...
            async function fetchColors(cateName) {
                try {
                    const response = await fetch('https://happywaycreations.52.66.203.206.nip.io:3000/colors', {
                        method: 'POST',
                        headers: {
