...
const fetchAverageRating = async (productId) => {
  ...
  try {
      const response = await fetch(`http://13.126.114.64:3000/getProductRating/${productId}`);
      if (!response.ok) {
...
const fetchProducts = async () => {
  try {
    const response = await fetch('http://13.126.114.64:3000/productsAll');
    if (!response.ok) {
      throw new Error('Network response was not ok');
    }
...
async function fetchProductsColor(color, cateName) {
  try {
      const response = await fetch('http://13.126.114.64:3000/productsByColor', {
          method: 'POST',
          headers: {
...
const fetchProductsByCategory = async (cateName) => {
  try {
      const response = await fetch(`http://13.126.114.64:3000/productsCate?category=${cateName}`);
      if (!response.ok) {
          throw new Error('Network response was not ok');
      }
      return await response.json();
...
const fetchProductsByCategoryAndPrice = async (category, price) => {
  try {
    const response = await fetch(`http://13.126.114.64:3000/productsByCategoryAndPrice?category=${category}&price=${price}`);
    if (!response.ok) {
      throw new Error('Network response was not ok');
    }
    return await response.json();
